...
Spodnji graf prikazuje povprečno starost igralcev, tu se osredotočimo na to da so odhodi večinoma starejši

```{r graf_starost, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Graf skupne vrednosti prestopov'}
...
print(c(napoved_prihod$coefficients['X'],napoved_odhod$coefficients['X']))
```
